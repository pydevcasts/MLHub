...
* MLP ممکن است چندین لایه پنهان داشته باشد، اما RBF فقط یک لایه پنهان دارد.
* MLP از توابعی مانند سیگموئید یا ReLU استفاده می‌کند، در حالی که RBF از توابع شعاعی استفاده می‌کند.
