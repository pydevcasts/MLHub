...
**سؤال 14: در یک نرون مصنوعی، چه نقشی برای سیناپس‌ها در نظر گرفته شده است؟**  
**پاسخ:**
...
**سؤال 15: چرا تابع فعال‌سازی غیرخطی در شبکه‌های عصبی ضروری است؟**
**پاسخ:**
...
**سؤال 16: تفاوت بین داده‌های آموزشی و داده‌های اعتبارسنجی چیست؟**
**پاسخ:**
...
**سؤال 17: مراحل کلی ساخت یک شبکه عصبی چیست؟**
**پاسخ:**
...
**سؤال 18: چه عواملی باعث موفقیت یا شکست آموزش یک شبکه می‌شوند؟**
**پاسخ:**
...
**سؤال 19: شبکه‌ی **Hopfield** چه ویژگی منحصربه‌فردی دارد و چه کاربردی می‌تواند داشته باشد؟**
**پاسخ:**
...
**سؤال 20:منظور از آموزش **فعال (Active Learning)** چیست و چه مزیتی دارد؟**
**پاسخ:**
...
**سؤال 21: با توجه به فرمول Kolmogorov، اگر یک شبکه عصبی دارای 3 ورودی باشد، حداقل چند نرون در لایه پنهان نیاز دارد؟**
**پاسخ:**
...
**سؤال 22: با توجه به نمودار توابع Sigmoid، Tanh و ReLU، کدام‌یک برای شبکه‌های عمیق مناسب‌تر است و چرا؟**
**پاسخ:**
