...
**سؤال 16: چرا تابع فعال‌سازی غیرخطی در شبکه‌های عصبی ضروری است؟**
**پاسخ:**
...
**سؤال 17: تفاوت بین داده‌های آموزشی و داده‌های اعتبارسنجی چیست؟**
**پاسخ:**
...
**سؤال 18: مراحل کلی ساخت یک شبکه عصبی چیست؟**
**پاسخ:**
...
**سؤال 19: چه عواملی باعث موفقیت یا شکست آموزش یک شبکه می‌شوند؟**
**پاسخ:**
...
**سؤال 20: شبکه‌ی **Hopfield** چه ویژگی منحصربه‌فردی دارد و چه کاربردی می‌تواند داشته باشد؟**
**پاسخ:**
...
**سؤال 21:منظور از آموزش **فعال (Active Learning)** چیست و چه مزیتی دارد؟**
**پاسخ:**
...
**سؤال 22: با توجه به فرمول Kolmogorov، اگر یک شبکه عصبی دارای 3 ورودی باشد، حداقل چند نرون در لایه پنهان نیاز دارد؟**
**پاسخ:**
...
**سؤال 23: با توجه به نمودار توابع Sigmoid، Tanh و ReLU، کدام‌یک برای شبکه‌های عمیق مناسب‌تر است و چرا؟**
**پاسخ:**
...
**سؤال 21:**
شبکه‌ی عصبی **Kohonen** بر پایه کدام نوع یادگیری عمل می‌کند؟
A) یادگیری نظارت‌شده
B) یادگیری بدون ناظر
C) یادگیری تقویتی
D) یادگیری نیمه‌نظارتی
✅ **پاسخ صحیح: B**
شبکه‌های Kohonen یا SOM (Self Organizing Maps) از یادگیری بدون ناظر استفاده می‌کنند 🧭.

---


**سؤال تستی 22:**
در روش آموزش **نیمه‌نظارتی (Semi-supervised)** چه نوع داده‌هایی استفاده می‌شود؟
A) فقط داده‌های برچسب‌دار
B) فقط داده‌های بدون برچسب
C) ترکیبی از برچسب‌دار و بدون برچسب
D) فقط داده‌های نویزی
✅ **پاسخ صحیح: C**
این روش ترکیبی از داده‌های دارای برچسب و بدون برچسب را برای آموزش استفاده می‌کند 🔄📊.

---

**سؤال تستی 23:**
کدام مورد زیر یکی از **شرایط توقف** در الگوریتم Backpropagation است؟
A) وقتی تابع فعال‌سازی صفر شود
B) وقتی نرخ یادگیری زیاد شود
C) وقتی تعداد epochها به حد معین برسد
D) وقتی همه وزن‌ها برابر شوند
✅ **پاسخ صحیح: C**
یکی از شرایط رایج توقف در BP رسیدن به تعداد مشخصی از epochهاست ⏳🛑.
