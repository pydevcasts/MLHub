...
ابتدا سه شاخص کلیدی برای هر آیتم $i$ محاسبه می‌کنیم:
...
3. **امتیاز بوردا (Borda Score):**
   ...
   اگر تعداد آیتم‌ها $n$ باشد، برای هر رتبه $r$، امتیاز آن برابر است با $n - r$. مجموع امتیازات هر آیتم از مدل‌های مختلف:
...
$$
\text{WeightedScore}_i = w_1 \cdot r_{1,i} + w_2 \cdot r_{2,i} + w_3 \cdot r_{3,i}
$$
