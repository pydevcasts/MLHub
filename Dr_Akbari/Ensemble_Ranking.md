...
* $n$ آیتم (گزینه) داریم که باید رتبه‌بندی شوند: $i = 1, 2, \dots, n$
* $m$ مدل یا منبع مختلف رتبه‌بندی داریم: $j = 1, 2, \dots, m$
...
اگر خواستی، می‌تونم برای هر کدوم یک [مثال عددی ساده](f) هم بنویسم.
